...
// 'HELLO WORLD', 'LOREM IPSUM', 'JAVASCRIPT IS COOL'
let mass3 = ['HELLO WORLD', 'LOREM IPSUM', 'JAVASCRIPT IS COOL'];
mass3.forEach(function (t){
...
let mass4 =[10,8,-7,55,987,-1011,0,1050,0];
let t = mass4.map( value => value+'');
console.log(t);
// #5hqyKTfmc
...
sortNums=(array,direction)=>{
    ...
    if(direction ==='descending') return result.reverse();
}
console.log(sortNums([11,22,3,4], 'descending'));
// ==========================
// #yo06d74c1C
// - є масив
